...
Office hours: Wed 9:30-11:30 AM
...
Tuesdays: 14-15 (2 College Green, room 3)

Thursdays: 17-18 (AP2.03)
...
Tuesdays: 12-1pm (Goldsmith 1A) (Group 1)

OR

Tuesdays: 5-6pm (College Green Rm 4) (Group 2)
...
-   60$\%$ of the mark is based on an end-of-term exam, which covers both research. A sample exam can be found [here](PO3110/PO3110_MT_exam_SAMPLE.pdf)
    methods and statistics. The exam will consist of short descriptions
...
-   1 paper counting 16$\%$ towards your overall mark. In this paper, you will
    ...
    for submitting the paper on Turnitin is Friday, November 30,
    2018, 23:59. Only one of the co-authors should submit the paper, but
    be sure to indicate the other co-authors on the title page.
     
     Details on the papers and what we expect can be found [here](PO3110/Assignments/PO3110PaperGuidelines.pdf)
     
     Details on the presentations and what we expect can be found [here](PO3110/Assignments/PO3110PresentationGuidelines.pdf)
...
All coursework must be submitted via
...
- [Methods Lecture (11/09)](PO3110/MethodsMT01.pdf): Why do I need to learn about research methods?
...
- [Statistics Lecture (no "methods" this week) (16/10)](PO3110/MethodsMT06.pdf): Bivariate statistics: cross tables and chi-square	
...
- [Statistics Lecture (30/10)](PO3110/StatisticsMT06.pdf):
...
- Tuesday: Presentations (6/11)

- Thursday: Presentations (8/11)
...
- Tuesday: Presentations (13/11)

- Thursday: Presentations (15/11)
